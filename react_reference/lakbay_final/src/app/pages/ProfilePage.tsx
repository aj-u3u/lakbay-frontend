  ...
  return (
    <div className="pb-20 bg-background min-h-screen">
      ...
      <div className="px-6 space-y-6">
        <section>
          <h4 className="mb-3 text-muted-foreground">Your Travel Stats</h4>
          <div className="bg-gradient-to-br from-primary to-primary/80 rounded-2xl p-5 text-white shadow-lg">
            <div className="flex items-center justify-between mb-4">
              <div>
                <p className="text-white/80 text-xs mb-1">Total Adventures</p>
                <h2 className="text-white text-3xl">12</h2>
              </div>
            ...
            <div className="grid grid-cols-3 gap-3 pt-3 border-t border-white/20">
              ...
              <div>
                <p className="text-white/70 text-xs">Districts</p>
                <p className="text-white text-lg">3/5</p>
              </div>
              <div>
        ...
        <section>
          <h4 className="mb-3 text-muted-foreground flex items-center gap-2">
